...
- 🤖 **Multi-agent by design** — three specialist agents draft answers in parallel, and a fourth aggregates them; produces more balanced and complete responses than a single pass
